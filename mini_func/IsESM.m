%% if it is ionic material
addpath 'C:\Users\Asylum User\Desktop\Go_AR 0427\mini_func';
line_length=[-16 -8 -4 -2  0  2 4 8 16];


%% Find GB by using SVM
...
% fprintf(2,'\n---------- The tip (Red spot) is close to grain boundary. ----------\n');
% pause(5);
% 
%     figure;
%     waitforbuttonpress;

%% Zoom in and check GB
